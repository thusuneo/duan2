...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav side-nav">
			<li class="active"><a href="<%=request.getContextPath()%>/admin"><i
					class="fa fa-fw fa-dashboard"></i> Dashboard</a></li>
			<li><a href="charts.html"><i class="fa fa-fw fa-bar-chart-o"></i>
					Charts</a></li>
			<li><a href="admin/categories"><i class="fa fa-fw fa-table"></i>
					Categories</a></li>
			<li><a href="admin/product"><i class="fa fa-fw fa-edit"></i>
					Products</a></li>
			<li><a href="admin/user"><i class="fa fa-fw fa-user"></i>
					User</a></li>
			<li><a href="admin/adminuser"><i class="fa fa-fw fa-user"></i>
					Admin</a></li>
